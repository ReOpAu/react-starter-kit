...
type ConfirmedSelectionsState = {
  ...
  addConfirmedSelection: (entry: Omit<ConfirmedSelectionEntry, "id" | "timestamp">) => void;
};

export const useConfirmedSelectionsStore = create<ConfirmedSelectionsState>((set) => ({
  selections: [],
