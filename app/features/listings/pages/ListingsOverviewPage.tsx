...
const ListingsOverviewPage: React.FC = () => {
	return (
		<>
			{/* Meta tags (could use react-helmet or similar in real app) */}
			<head>
				<title>Property Listings - REOP</title>
				<meta
					name="description"
					content="Browse and search property listings from buyers and sellers. Find your perfect property match or list your requirements."
				/>
			</head>
