 ...
 */
export function calculateListingDistance(listing1: ListingWithCoordinates, listing2: ListingWithCoordinates): number | null {
 ...
 */
export function calculateAndFormatListingDistance(listing1: ListingWithCoordinates, listing2: ListingWithCoordinates): string {
 ...
 */
function getCoordinates(listing: ListingWithCoordinates): DistanceCoordinates | null {
