...
import { Home, Bed, Car } from "lucide-react";
	...
	return (
		<div className="flex flex-wrap gap-x-6 gap-y-2 text-sm text-gray-600">
			...
			<div className="flex items-center gap-1">
				...
				<span>{bedrooms || 0} bed{bedrooms !== 1 ? 's' : ''}</span>
			</div>
			...
			<div className="flex items-center gap-1">
				<svg 
					...
					stroke="currentColor"
				>
					<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 21l4-4 4 4M3 20h18M3 20a2 2 0 01-2-2V6a2 2 0 012-2h18a2 2 0 012 2v12a2 2 0 01-2 2" />
				</svg>
				<span>{bathrooms || 0} bath{bathrooms !== 1 ? 's' : ''}</span>
			</div>
