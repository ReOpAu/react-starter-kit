...
import { Plus, X, Home, Building2, ArrowLeft } from "lucide-react";
...
export function CreateListingFormComponent() {
	...
	const addFeature = (type: "mustHaveFeatures" | "niceToHaveFeatures" | "features") => {
	...
	const removeFeature = (type: "mustHaveFeatures" | "niceToHaveFeatures" | "features", index: number) => {
		const currentFeatures = form.getValues(type) || [];
		form.setValue(type, currentFeatures.filter((_, i) => i !== index));
	};

	const addCommonFeature = (feature: string, type: "mustHaveFeatures" | "niceToHaveFeatures" | "features") => {
		const currentFeatures = form.getValues(type) || [];
									...
									<FormField
										...
										render={({ field }) => (
											<FormItem>
												...
												<input type="hidden" name="listingType" value={field.value} />
												<FormMessage />
											</FormItem>
										)}
									/>
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											...
											<FormDescription>
												Detailed description of your requirements or property (20-1000 characters)
											</FormDescription>
											<FormMessage />
										</FormItem>
									)}
									...
									<FormField
										...
										render={({ field }) => (
											<FormItem>
												...
												<input type="hidden" name="state" value={field.value || ""} />
												<FormMessage />
											</FormItem>
										)}
									/>
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											...
											<input type="hidden" name="buildingType" value={field.value} />
											<FormMessage />
										</FormItem>
									)}
								/>
									...
									<FormField
										...
										render={({ field }) => (
											<FormItem>
												...
												<input type="hidden" name="bedrooms" value={field.value} />
												<FormMessage />
											</FormItem>
										)}
									/>
									...
									<FormField
										...
										render={({ field }) => (
											<FormItem>
												...
												<input type="hidden" name="bathrooms" value={field.value} />
												<FormMessage />
											</FormItem>
										)}
									/>
									...
									<FormField
										...
										render={({ field }) => (
											<FormItem>
												...
												<input type="hidden" name="parkingSpaces" value={field.value} />
												<FormMessage />
											</FormItem>
										)}
									/>
									...
									<FormField
										...
										render={({ field }) => (
											<FormItem>
												...
												<input type="hidden" name="landArea" value={field.value || ""} />
												<FormMessage />
											</FormItem>
										)}
									/>
									...
									<FormField
										...
										render={({ field }) => (
											<FormItem>
												...
												<input type="hidden" name="floorArea" value={field.value || ""} />
												<FormMessage />
											</FormItem>
										)}
									/>
									...
									<FormField
										...
										render={({ field }) => (
											<FormItem>
												...
												<input type="hidden" name="priceMin" value={field.value || ""} />
												<FormMessage />
											</FormItem>
										)}
									/>
									...
									<FormField
										...
										render={({ field }) => (
											<FormItem>
												...
												<input type="hidden" name="priceMax" value={field.value || ""} />
												<FormMessage />
											</FormItem>
										)}
									/>
									...
									<FormField
										...
										render={({ field }) => (
											<FormItem>
												...
												<input type="hidden" name="radiusKm" value={field.value || ""} />
												<FormMessage />
											</FormItem>
										)}
									/>
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
											...
											<input type="hidden" name="isPremium" value={field.value ? "true" : "false"} />
										</FormItem>
									)}
								/>
							</CardContent>
