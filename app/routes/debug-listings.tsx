...
export default function DebugListings() {
  ...
  return (
    <div className="p-8">
      ...
      <div className="mb-8">
        <h2 className="text-xl font-semibold">Total Listings: {allListings.length}</h2>
      </div>
      ...
      <div className="mb-8">
        <h2 className="text-xl font-semibold mb-2">Filtered Listings (seller, vic, Toorak): {filteredListings.length}</h2>
      ...
      {allListings.length === 0 && (
        <div className="mt-8 p-4 bg-yellow-100 rounded">
          ...
          <p>Check the console or run the seed function to create test listings.</p>
        </div>
      )}
    </div>
  );
