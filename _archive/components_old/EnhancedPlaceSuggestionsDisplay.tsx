		...
		<Card className="bg-slate-50 border-slate-200">
			<CardHeader>
				<CardTitle className="flex items-center justify-between">
					<div className="flex items-center gap-2">
						...
						<Badge
							variant="outline"
							className={cn("text-xs", intentDisplay.color)}
						>
			...
			<CardContent className="space-y-4">
				<p className="text-sm text-slate-600">
					Found {suggestions.length} places. Results are organized by type and
					ranked by relevance:
				</p>

				{/* Display grouped results */}
				{Object.entries(groupedSuggestions).map(
					([resultType, typeSuggestions]) => {
				...
				<div className="text-xs text-muted-foreground bg-white p-3 rounded border">
					<p>
						<strong>Types explained:</strong>
					</p>
					<ul className="mt-1 space-y-1">
						<li>
							🏘️ <strong>Suburb:</strong> Residential areas and localities
						</li>
						<li>
							🛣️ <strong>Street:</strong> Roads, streets, and thoroughfares
						</li>
						<li>
							🏠 <strong>Address:</strong> Specific building addresses
						</li>
						<li>
							📍 <strong>General:</strong> Other geographic locations
						</li>
					</ul>
				</div>
			</CardContent>
