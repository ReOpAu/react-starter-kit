...
export const CountryEnum = z.enum(
	Object.keys(Country) as [string, ...string[]],
);
export const BuildingTypeEnum = z.enum(
	Object.keys(BuildingType) as [string, ...string[]],
);
export const BuyerListingTypeEnum = z.enum(
	Object.keys(BuyerListingType) as [string, ...string[]],
);
export const SellerListingTypeEnum = z.enum(
	Object.keys(SellerListingType) as [string, ...string[]],
);
export const PropertyFeatureEnum = z.enum(
	Object.keys(PropertyFeature) as [string, ...string[]],
);
...
export const PriceRangeEnum = z.enum(
	Object.keys(PriceRangeValues) as [string, ...string[]],
);
