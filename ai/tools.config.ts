...
export const addressSearchSchema = z.object({
	address: z
		.string()
		.describe("The address, suburb, or street name to search for"),
});

export const confirmPlaceSchema = z.object({
	address: z
		.string()
		.describe("The full place description from previous AddressSearch"),
});
...
export const toolDefinitions = {
	...
	AddressSearch: {
		description:
			"Search for Australian addresses, suburbs, or streets. Returns place data for confirmation.",
		parametersSchema: addressSearchSchema,
	},
	ConfirmPlace: {
		description:
			"Display one or more place suggestions in the UI so the user can confirm or select the correct one.",
